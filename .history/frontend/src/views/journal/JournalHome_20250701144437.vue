          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <select
                ...
                class="form-select"
                :aria-describedby="referentChildren.length === 0 ? 'child-empty-message' : 'child-help-text'"
              ...
              <div v-else id="child-help-text" class="help-text">
                {{ referentChildren.length }} enfant{{ referentChildren.length > 1 ? 's' : '' }} référé{{ referentChildren.length > 1 ? 's' : '' }}
              </div>
            </div>
            ...
            <div v-if="selectedChildId" class="info-item">
              ...
              <select
                ...
                @change="onYearChange"
                class="form-select"
                :aria-describedby="academicYears.length === 0 ? 'year-empty-message' : 'year-help-text'"
              ...
              <div v-else id="year-help-text" class="help-text">
                {{ academicYears.length }} année{{ academicYears.length > 1 ? 's' : '' }} disponible{{ academicYears.length > 1 ? 's' : '' }}
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="months-container" id="months-grid">
            <div class="months-grid" role="grid" aria-label="Grille des rapports mensuels par mois">
              <button
                ...
                :aria-describedby="`month-${index + 1}-status`"
                :disabled="!isMonthEditable(index + 1) && !isMonthConsultable(index + 1) && !hasDraft(index + 1)"
              >
                <div class="month-content">
                  <span class="month-label">{{ label }}</span>
                  <div class="month-status" :id="`month-${index + 1}-status`">
                    <!-- ✔ pour mois soumis -->
