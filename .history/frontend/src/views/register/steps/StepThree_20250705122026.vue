        ...
        <div class="register-step__grid register-step__grid--account">
          ...
          <div class="register-step__password-container">
            ...
            <div v-if="form.password" class="register-step__password-strength">
              <div class="register-step__strength-indicator" :class="passwordStrength.class">
                <div class="register-step__strength-bar" :style="{ width: passwordStrength.percentage + '%' }"></div>
              </div>
              <div class="register-step__strength-text" :class="passwordStrength.class">
                {{ passwordStrength.text }}
              </div>
              <div class="register-step__password-requirements">
                <div class="register-step__requirement" :class="{ 'met': passwordChecks.length }">
                  <span class="register-step__check-icon">{{ passwordChecks.length ? '✓' : '✗' }}</span>
                  Au moins 12 caractères
                </div>
                <div class="register-step__requirement" :class="{ 'met': passwordChecks.uppercase }">
                  <span class="register-step__check-icon">{{ passwordChecks.uppercase ? '✓' : '✗' }}</span>
                  Une majuscule (A-Z)
                </div>
                <div class="register-step__requirement" :class="{ 'met': passwordChecks.lowercase }">
                  <span class="register-step__check-icon">{{ passwordChecks.lowercase ? '✓' : '✗' }}</span>
                  Une minuscule (a-z)
                </div>
                <div class="register-step__requirement" :class="{ 'met': passwordChecks.number }">
                  <span class="register-step__check-icon">{{ passwordChecks.number ? '✓' : '✗' }}</span>
                  Un chiffre (0-9)
                </div>
                <div class="register-step__requirement" :class="{ 'met': passwordChecks.special }">
                  <span class="register-step__check-icon">{{ passwordChecks.special ? '✓' : '✗' }}</span>
...
// État de la force du mot de passe
