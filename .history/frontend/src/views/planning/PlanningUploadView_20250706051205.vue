          ...
          <div class="header-content">
            <div class="title-section">
              ...
              <div class="title-info">
                <h1 style="color: white;">Planning Semestriel</h1>
                <p class="subtitle">Import et gestion des emplois du temps pour tous les éducateurs</p>
              </div>
            </div>
            
            <!-- Indicateur de statut -->
            <div v-if="selectedSemesterId && hasExistingPlanning" class="status-indicator">
              <i class="material-icons">check_circle</i>
              <span>Planning validé</span>
            </div>
            <div v-else-if="selectedSemesterId && file" class="status-indicator">
