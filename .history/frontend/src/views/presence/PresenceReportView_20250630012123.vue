      ...
      <div class="profile-content">
        <div class="content-grid">
          ...
          <div class="profile-section">
            ...
            <div v-if="sheet" class="status-badge" :class="statusClass" role="status" :aria-label="`Statut: ${statusText}`">
          ...
          <!-- Alertes critiques -->
          <div v-if="sheet && hasAlerts" class="alert-section" role="alert" aria-live="polite">
            <div class="section-header">
              <h2>
            ...
            <div class="alerts-grid">
              ...
              >
                ...
                <div class="alert-content">
                  <h3>Taux de présence critique</h3>
                  <p>{{ attendanceRate }}% (seuil: 90%)</p>
                </div>
              </div>
          ...
          <div v-if="sheet" class="profile-section" id="kpi-section">
            ...
            <div class="kpi-grid" role="group" aria-labelledby="kpi-section">
              <div class="kpi-card attendance" :class="{ 'kpi-critical': attendanceRate < 90 }">
                <div class="kpi-icon">
...
const statusClass = computed(() => {
  ...
  switch (sheet.value.status) {
    ...
    case 'PENDING_SECRETARY':
      return 'status-pending-secretary';
    case 'VALIDATED':
...
// Alertes
const hasAlerts = computed(() => attendanceRate.value < 90 || unjustAbsenceRate.value > 10);
