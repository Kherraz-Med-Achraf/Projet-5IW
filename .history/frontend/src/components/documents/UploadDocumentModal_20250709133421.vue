...
onMounted(async () => {
  ...
  try {
    // Nous devons créer cette méthode dans parentStore
    ...
    parents.value = [
      {
        ...
        children: [{ id: 1, firstName: 'Marie', lastName: 'Dupont' }]
      },
      {
        id: 2,
        firstName: 'Sophie',
        lastName: 'Martin',
        user: { email: 'sophie.martin@email.com' },
        children: [
          { id: 2, firstName: 'Pierre', lastName: 'Martin' },
          { id: 3, firstName: 'Julie', lastName: 'Martin' }
        ]
      }
    ]
  } catch (error) {
