...
describe('ChatController', () => {
  ...
  describe('getChats', () => {
    it('should return user chats', async () => {
      ...
      const result = await controller.getChats(mockRequest as any);

      expect(service.getUserChats).toHaveBeenCalledWith('user-123');
    ...
    it('should handle service errors', async () => {
      mockChatService.getUserChats.mockRejectedValue(
        new Error('Database connection failed')
      );

      await expect(controller.getChats(mockRequest as any))
  ...
  describe('getContacts', () => {
    it('should return available contacts', async () => {
      ...
      expect(service.getContacts).toHaveBeenCalledWith('user-123');
  ...
  describe('role-based access', () => {
    it('should allow STAFF to access chats', async () => {
      ...
      mockChatService.getUserChats.mockResolvedValue([mockChat]);

      const result = await controller.getChats(staffRequest as any);
    ...
    it('should allow SECRETARY to access chats', async () => {
      ...
      const result = await controller.getChats(secretaryRequest as any);
    ...
    it('should allow PARENT to access chats', async () => {
      ...
      const result = await controller.getChats(parentRequest as any);
