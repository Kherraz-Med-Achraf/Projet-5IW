<template>
  <main class="profile-container" role="main" lang="fr">
    ...
    <div class="skip-links">
      ...
      <a href="#blog-stats" class="skip-link">Aller aux statistiques</a>
    ...
    <div class="profile-content" id="main-content">
      <div class="content-grid">
        ...
        <div class="profile-section">
          <div class="section-header">
            ...
            <div class="info-note" role="note">
              ...
              <span>Administration du blog - Gérez, modifiez et suivez tous les articles</span>
            </div>
          </div>
        ...
        <div class="profile-section" id="blog-stats">
          <div class="section-header">
            <h2>
