...
export class ServiceManagerController {
  ...
  /**
   * SECRETARY, SERVICE_MANAGER, DIRECTOR et ADMIN peuvent récupérer
   * SERVICE_MANAGER peut récupérer SON propre profil
   */
  @Get(':id')
  @Roles(
    Role.SECRETARY,
  ...
  /**
   * SERVICE_MANAGER peut mettre à jour SON profil,
   * DIRECTOR et ADMIN peuvent mettre à jour n'importe quel profil
   */
  @Patch(':id')
