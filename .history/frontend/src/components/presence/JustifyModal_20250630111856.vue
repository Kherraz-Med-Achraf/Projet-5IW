<template>
  ...
  function onFileChange(e: Event) {
    ...
    if (selectedFile) {
      ...
      // Remplacer les caractères interdits par des tirets et supprimer les tirets multiples
      const cleanName = nameWithoutExt
        .replace(/[^a-zA-Z0-9._-]/g, '-')  // Remplacer caractères interdits par -
      ...
      if (originalName !== finalName) {
        ...
        notify.showNotification(
          `Le nom de votre fichier a été automatiquement nettoyé pour respecter les règles de sécurité. Nouveau nom: "${finalName}"`,
          'info'
        );
      }
