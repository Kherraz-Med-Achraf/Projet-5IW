<template>
  ...
  // On récupère prid et token depuis l'URL, ex:  /reset-password?prid=123&token=xxxxx
  // prid => number, token => string
  ...
  async function onSubmit() {
    ...
    try {
      // On appelle la méthode du store en lui passant les 3 paramètres
