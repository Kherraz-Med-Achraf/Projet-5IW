...
import { Controller, Post, Body, Param, ParseIntPipe, UseGuards, Get, Query, UploadedFile, UseInterceptors, Patch, Req } from '@nestjs/common';
...
export class PresenceController {
  ...
  validateSheet(
    ...
    return this.service.validateSheet(sheetId, dto.presentChildIds, staffId);
  }
