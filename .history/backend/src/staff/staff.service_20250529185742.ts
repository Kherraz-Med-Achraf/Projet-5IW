...
export class StaffService {
  ...
  /**
   * Crée un nouveau staff en s’assurant :
   * - que l’email n’existe pas déjà (tous rôles confondus)
   * - qu’aucun autre staff n’a le même prénom + nom
   */
  async create(dto: CreateStaffDto) {
    ...
    // 4) Transaction : création User puis StaffProfile
