...
/** Fonctions utilitaires - copie exacte de PlanningUploadView.vue **/
...
const displayEvents = computed(() => {
  ...
  return events.value.map(event => {
    // Détecter si le cours est annulé
    ...
    // Modifier le titre pour les cours annulés
    let displayTitle = event.activity
    if (isCancelled && !displayTitle.toLowerCase().startsWith('annulé')) {
