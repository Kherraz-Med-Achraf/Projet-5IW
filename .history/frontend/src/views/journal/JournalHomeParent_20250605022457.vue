...
<template>
  ...
  // Au montage, charger la liste des enfants référents et des années
  onMounted(async () => {
    // Récupération des enfants où l’utilisateur est référent
    // (le store childStore doit déjà contenir referentChildren)
