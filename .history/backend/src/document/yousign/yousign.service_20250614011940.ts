/* src/document/yousign/yousign.service.ts
   Service Yousign – compatible Node 18 / Nest v10 +
   Dépendances :  undici  (npm i undici  &&  npm i -D @types/undici) */
  ...
  import { FormData } from 'undici';                // <- FormData natif undici
