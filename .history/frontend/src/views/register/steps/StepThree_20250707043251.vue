<template>
  <div class="register-step">
    <div class="register-step__container">
      <h1 class="register-step__title">Création du compte</h1>

      <!-- Formulaire de création de compte -->
      <div class="register-step__section">
        <h2 class="register-step__subtitle">Informations de connexion</h2>
      ...
      <div class="register-step__summary">
        <h2 class="register-step__summary-title">
          Récapitulatif de votre inscription
        </h2>

        <!-- Informations parent -->
        <div class="register-step__summary-section">
          <h3 class="register-step__summary-subtitle">
        ...
        <!-- Email -->
        <div class="register-step__summary-section">
          <h3 class="register-step__summary-subtitle">Compte</h3>
          <p class="register-step__summary-item">
      ...
      <div class="register-step__rgpd-section">
        <h2 class="register-step__subtitle">🔒 Consentements et Protection des Données</h2>
        
        <!-- Droit à l'image (optionnel) -->
        <div class="register-step__consent-block">
          <h3 class="register-step__consent-title">📸 Droit à l'image</h3>
        ...
        <div class="register-step__consent-block">
          <h3 class="register-step__consent-title">Politique de Confidentialité</h3>
          <div class="register-step__checkbox-container">
            <input 
              type="checkbox" 
              ...
              class="register-step__checkbox"
              required
              aria-describedby="consent-privacy-policy-error"
            />
          ...
          <div 
            v-if="errors.consentPrivacyPolicy" 
            id="consent-privacy-policy-error"
            class="register-step__error"
            role="alert"
            aria-live="polite"
          >
      ...
      <div class="register-step__nav-buttons">
        ...
        <button
          ...
          :aria-label="registerStore.loading ? 'Création du compte en cours' : 'Créer le compte'"
        >
...
.register-step {
  ...
  &__check-icon {
    ...
    .register-step__requirement.met & {
      background-color: #16a34a;
      color: #fff;
    }
  }
