...
// Données utilisateur temporaires (à récupérer depuis l'API)
...
onMounted(() => {
  ...
  // Ici tu pourras faire un appel API pour récupérer les infos complètes du profil
  // pour l'instant on utilise des valeurs par défaut
  userFirstName.value = 'Prénom'; // À remplacer par l'API
  userLastName.value = 'Nom'; // À remplacer par l'API
});
