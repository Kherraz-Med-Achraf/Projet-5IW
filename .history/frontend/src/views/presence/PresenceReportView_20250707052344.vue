      ...
      <div class="profile-content">
        <div class="content-grid">
          ...
          <PageHeader
            ...
            :subtitle="sheet ? `${totalCount} enfant${totalCount > 1 ? 's' : ''} inscrit${totalCount > 1 ? 's' : ''}` : ''"
            icon="assessment"
            :status-text="sheet && shouldShowStatus ? statusText : ''"
            :status-icon="sheet && shouldShowStatus ? statusIcon : ''"
            :status-class="sheet && shouldShowStatus ? statusClass : ''"
          />
