  ...
  <main class="profile-container" role="main" lang="fr">
    ...
    <div class="profile-content" id="main-content">
      <div class="content-grid">
        ...
        <PageHeader 
          title="Journal de bord éducatif" 
          subtitle="Suivi mensuel et missions annuelles des enfants dont vous êtes référent"
          icon="book" 
        />
        ...
        <section class="profile-section" id="child-selection" aria-labelledby="selection-title">
          ...
          <div class="section-content">
            <div class="info-note" role="note">
              ...
              <span>Choisissez un enfant et une année scolaire pour accéder au journal</span>
            </div>
        ...
        <section v-if="selectedChildId && selectedYearId" class="profile-section" aria-labelledby="missions-title">
          ...
          <div class="section-content">
            ...
            <div v-if="missions.length" class="missions-display" id="missions-section" role="region" aria-labelledby="missions-list-title">
              ...
              <!-- Bouton Gérer les missions en bas à droite -->
            ...
            <div v-else class="empty-state" role="status" aria-live="polite">
              ...
              <!-- Bouton Gérer les missions pour l'état vide -->
              <div class="missions-actions">
                <button
                  @click="onManageMissions"
                  class="edit-btn edit-btn-custom"
                  type="button"
                  :aria-describedby="'no-missions-help'"
                >
                  <span class="material-icons" aria-hidden="true">edit</span>
                  Gérer les missions
                  <span class="sr-only">de l'enfant sélectionné</span>
                ...
                >
                  <div class="month-content">
                    ...
                    <div class="month-status" :id="`month-${monthNumbers[index]}-status`">
                      ...
                      <span v-else-if="isMonthEditable(monthNumbers[index])" class="month-icon editable" aria-label="Disponible pour rédaction">
                        <span class="material-icons" aria-hidden="true">edit</span>
                      </span>
                      <!-- ❌ pour mois futurs -->
    ...
    <div v-if="loading" class="loading-indicator" role="status" aria-live="polite">
      <span class="material-icons spinning" aria-hidden="true">sync</span>
...
/* En-têtes de section uniformes - prennent toute la largeur */
.section-header {
  background: #4444ac;
...
/* Ajuster le contenu des sections existantes */
.info-note {
  display: flex;
  align-items: center;
  gap: 0.5rem;
...
/* Style spécifique pour le label "Enfant référé" */
...
/* Style pour le label "Année scolaire" pour l'alignement */
.form-label:has(+ #year-select),
...
.form-select {
  ...
  background: white;
  font-size: 1rem;
  color: #1f2937 !important; /* Couleur de texte foncée pour la lisibilité */
  transition: all 0.2s ease;
  cursor: pointer;
...
/* Actions des missions - bouton en bas à droite */
.missions-actions {
  display: flex;
