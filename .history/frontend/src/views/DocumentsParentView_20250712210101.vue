...
.document-card {
  ...
  min-height: 200px; /* 🔧 Hauteur minimale pour éviter les cartes trop petites */
}
...
.document-icon {
  ...
  color: #4444ac;
  min-width: 48px; /* 🔧 Largeur minimale pour les icônes */
}
...
.document-title {
  margin: 0 0 0.5rem 0; /* 🔧 Augmenté de 0.25rem à 0.5rem */
  font-size: 1.25rem; /* 🔧 Augmenté de 1.125rem à 1.25rem */
  font-weight: 600;
  color: #1e293b;
  line-height: 1.3; /* 🔧 Amélioration de la hauteur de ligne */
}
...
.document-badges {
  display: flex;
  flex-direction: column;
  gap: 0.5rem; /* 🔧 Augmenté de 0.25rem à 0.5rem */
}
...
.viewed-badge {
  ...
  align-items: center;
  gap: 0.25rem;
  padding: 0.375rem 0.75rem; /* 🔧 Augmenté le padding */
  border-radius: 6px;
...
.document-description {
  ...
  color: #64748b;
  font-size: 0.875rem;
  line-height: 1.5; /* 🔧 Amélioration de la hauteur de ligne */
}

.document-info {
  margin-bottom: 1.5rem; /* 🔧 Nouvel espacement */
}

.info-grid {
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); /* 🔧 Augmenté de 120px à 140px */
...
.info-item {
  display: flex;
  flex-direction: column;
  gap: 0.375rem; /* 🔧 Augmenté de 0.25rem à 0.375rem */
}
...
.info-value {
  font-size: 0.875rem;
  color: #1e293b;
  font-weight: 500; /* 🔧 Ajout de poids */
}
...
.document-actions {
  display: flex;
  gap: 0.75rem; /* 🔧 Augmenté de 0.5rem à 0.75rem */
  flex-wrap: wrap;
...
.doc-action-btn {
  ...
  align-items: center;
  gap: 0.375rem; /* 🔧 Augmenté de 0.25rem à 0.375rem */
  padding: 0.625rem 1.25rem; /* 🔧 Augmenté le padding */
  border-radius: 6px;
  font-size: 0.875rem;
  font-weight: 500;
  border: 1px solid;
...
.doc-action-btn .material-icons {
  font-size: 1.1rem; /* 🔧 Icônes des boutons légèrement plus grandes */
}
