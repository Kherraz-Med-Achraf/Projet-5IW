    ...
    >
      <div class="modal-content create-post-form">
        <div class="modal-header">
          <h3 id="modal-title">✨ Créer un nouveau post</h3>
          <button
            type="button"
            @click="handleClose"
        ...
        <form @submit.prevent="handleSubmit" class="post-form">
          ...
          >
            ...
            <div class="suggestion-text" role="article" v-text="titleProposal"></div>
          ...
          >
            ...
            <div class="suggestion-text" role="article" v-text="descriptionProposal"></div>
          ...
          <div class="form-group">
            ...
            <div class="file-upload">
              <input
                ...
                ref="fileInput"
                class="file-input"
                :aria-describedby="selectedFile ? 'file-help' : 'file-description'"
              />
              <div id="file-description" class="file-description">
                Formats acceptés: images (JPG, PNG, GIF) et vidéos (MP4, WebM). Taille maximale: 50MB
              </div>
              <div v-if="selectedFile" class="file-preview" id="file-help">
                <span class="file-name" v-text="selectedFile.name"></span>
                <button 
                  type="button" 
                  @click="removeFile" 
                  class="remove-file"
          ...
          <div class="form-actions" role="group" aria-label="Actions du formulaire">
            ...
            <button
              ...
              class="btn-primary"
              :aria-describedby="loading ? 'submit-loading' : 'submit-help'"
            >
              {{ loading ? "Création..." : "Publier le post" }}
            </button>
            <div id="submit-help" class="sr-only">
              Publier l'article sur le blog de l'école
            </div>
            <div v-if="loading" id="submit-loading" class="sr-only">
              Création de l'article en cours, veuillez patienter
            </div>
          </div>
        </form>
      </div>
