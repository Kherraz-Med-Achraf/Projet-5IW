...
export class DocumentService {
  ...
  async createDocument(
    ...
    console.log('🔍 DEBUG createDocument service:')
    console.log('- dto.requiresSignature:', dto.requiresSignature, typeof dto.requiresSignature)
    console.log('- dto.title:', dto.title)
    console.log('- dto.category:', dto.category)
    console.log('- dto.parentIds:', dto.parentIds)
    ...
    console.log('✅ Fichier chiffré sauvegardé:', filepath);
    ...
    console.log('✅ Métadonnées sauvegardées:', metaFilepath);
    ...
    if (document.requiresSignature) {
      ...
      try {
        ...
        try {
          ...
          console.log('✅ Fallback signature entries created')
        } catch (fallbackError) {
          console.error('❌ Failed to create fallback signatures:', fallbackError.message);
        }
      }
    } else {
