...
/* FORCE FIX: Eliminate any scroll issues on this page */
.profile-container {
  min-height: unset !important;
  height: auto !important;
}

/* Ensure main containers don't force extra height */
.profile-content, .journal-month-container {
  min-height: unset !important;
  height: auto !important;
}

/* Removed html/body reset - was causing scroll issues */
...
/* SIMPLIFIED STYLES - No complex height/overflow rules */
.profile-container {
...
.journal-month-container {
  /* Ultra simple container - no height/overflow rules */
}

/* Simplified Loading State - no min-height constraint */
.loading-state {
  display: flex;
