      ...
      <div class="content-grid">
        ...
        <section class="profile-section" id="semester-selection" aria-labelledby="config-title">
          ...
          <div class="instructions-section">
            <div class="instruction-card" role="complementary" aria-labelledby="instructions-title">
              <div class="instruction-icon" aria-hidden="true">
                <i class="material-icons">info</i>
              </div>
              <div class="instruction-content">
                <h3 id="instructions-title">Instructions d'utilisation</h3>
                <ul role="list">
...
.main-header {
  background: #4444ac; color: white; padding: 2rem 2rem 1rem 2rem; border-radius: 1rem; box-shadow: 0 10px 30px rgba(68, 68, 172, 0.3);
  margin-bottom: 1rem;
