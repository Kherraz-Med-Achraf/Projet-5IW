...
/** 3) Computed temporaire pour filtrer les events **/
...
/** 5) À chaque changement de filteredEvents ou selectedStaffId, on met à jour le calendrier et on log **/
watch(
...
/** 6) Réinitialiser tout au changement de semestre **/
...
/** 7) Gestion du fichier Excel **/
function onFileChange(e: Event) {
  file.value = (e.target as HTMLInputElement).files?.[0] ?? null
}

/** 8) Appels au store pour preview / import / submit **/
...
/** 9) Au montage, on charge semestres & éducateurs **/
onMounted(async () => {
