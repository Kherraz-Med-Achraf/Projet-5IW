<template>
    <div class="chat-container">
      ...
      <div class="content">
        <header class="chat-header">
          <span class="avatar-lg" :style="{ background: colorFromId(currentChat.id || activeId) }">
  ...
  /* Charger et rejoindre */
  onMounted(async () => {
    await chatStore.init();
    chatStore.join(activeId.value);
  });
  
  /* Réagir au changement d’URL /chat/:id */
