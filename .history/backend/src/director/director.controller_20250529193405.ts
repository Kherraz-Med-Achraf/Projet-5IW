...
export class DirectorController {
  ...
  /** Liste accessible à SECRETARY, SERVICE_MANAGER, DIRECTOR et ADMIN */
  @Get()
  ...
  /** Détail accessible aux mêmes rôles */
  @Get(':id')
  @Roles(Role.SECRETARY, Role.SERVICE_MANAGER, Role.DIRECTOR, Role.ADMIN)
  ...
  /** Mise à jour accessible à DIRECTOR et ADMIN */
  @Patch(':id')
  @Roles(Role.DIRECTOR, Role.ADMIN)
  update(
  ...
  /** Suppression accessible à DIRECTOR et ADMIN */
  @Delete(':id')
  @Roles(Role.DIRECTOR, Role.ADMIN)
