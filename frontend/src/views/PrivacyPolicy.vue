  ...
  <div class="privacy-policy">
    ...
    <div class="privacy-content">
      ...
      <section class="privacy-section">
        <h2>Introduction</h2>
        <p>
          L'APAJH (Association pour Adultes et Jeunes Handicapés) s'engage à
          protéger et respecter votre vie privée. Cette politique de
          confidentialité explique comment nous collectons, utilisons et
          protégeons vos données personnelles dans le cadre de notre plateforme
      ...
      <section class="privacy-section">
        ...
        <div class="contact-card">
          <h3>APAJH</h3>
          <p>
            <strong>Adresse :</strong> 2 Rue Alfred Gillet, 94380
            Bonneuil-sur-Marne
          </p>
          <p><strong>Téléphone :</strong> 01 43 99 20 85</p>
          <p><strong>Email :</strong> apajh94.secretary@gmail.com</p>
          <p>
        ...
        <div class="data-categories">
          ...
          <div class="data-category sensitive">
            ...
            <p class="sensitive-note">
              Ces données sont particulièrement protégées et stockées sur des
              serveurs agréés HDS (Hébergement de Données de Santé)
            </p>
          </div>
      ...
      <section class="privacy-section">
        ...
        <div class="purposes">
          <div class="purpose">
            ...
            <p class="legal-basis">
              <strong>Base légale :</strong> Mission d'intérêt public
            </p>
          </div>
          ...
          <div class="purpose">
            ...
            <p>
              Protection des comptes, prévention des fraudes, respect des
              obligations légales.
            </p>
            <p class="legal-basis">
              <strong>Base légale :</strong> Obligation légale et intérêt
              légitime
            </p>
          </div>
          ...
          <div class="purpose">
            ...
            <p>
              Analyse anonymisée de l'utilisation pour améliorer la plateforme
      ...
      <section class="privacy-section">
        ...
        <div class="recipients">
          <div class="recipient">
            ...
            <p>
              Les éducateurs, enseignants et personnel d'accompagnement ont
              accès aux données des enfants qu'ils suivent dans le cadre de leur
              mission éducative.
            </p>
          </div>
          ...
          <div class="recipient">
            ...
            <p>
              La direction et le secrétariat ont accès aux données nécessaires à
          ...
          <div class="recipient">
            ...
            <p>
              Les parents ont accès uniquement aux données concernant leurs
              propres enfants via leur espace personnel sécurisé.
            </p>
          </div>
          ...
          <div class="recipient">
            ...
            <p>
              Nos prestataires d'hébergement et de maintenance technique, tous
              soumis à des obligations contractuelles strictes de
              confidentialité.
            </p>
          </div>
          ...
          <div class="recipient no-sharing">
            ...
            <p>
              ...
              personnelles à des fins commerciales. Aucune donnée n'est
        ...
        <div class="retention-periods">
          <div class="retention-item">
            ...
            <p class="retention-reason">
              Pour assurer la continuité éducative et répondre aux demandes de
              certificats.
            </p>
          </div>
          ...
          <div class="retention-item">
            ...
            <p class="retention-reason">
              Conformément aux obligations légales de conservation des dossiers
              médicaux.
            </p>
          </div>
      ...
      <section class="privacy-section">
        ...
        <div class="user-rights">
          ...
          <div class="right">
            ...
            <p>
              ...
              personnelles si elles sont inexactes ou incomplètes.
            </p>
          </div>
        ...
        <div class="rights-info">
          <p>
            <strong>Délai de réponse :</strong> Nous nous engageons à répondre à
            vos demandes dans un délai maximum de <strong>72 heures</strong> (1
            mois maximum pour les demandes complexes).
          </p>
          <p>
            <strong>Exercice gratuit :</strong> L'exercice de vos droits est
            entièrement gratuit, sauf en cas de demandes manifestement infondées
            ou excessives.
          </p>
        </div>
      </section>
      ...
      <section class="privacy-section">
        ...
        <div class="cookies-info">
          <div class="cookie-category">
            ...
            <p>
              ...
              sécurité). Ces cookies ne peuvent pas être désactivés.
            </p>
          </div>
          ...
          <div class="cookie-category">
            ...
            <p>
              Nous permettent d'analyser l'utilisation de la plateforme pour
              l'améliorer. Vous pouvez les refuser sans impact sur le
              fonctionnement.
            </p>
          </div>
        </div>
        ...
        <p>
          Aucun cookie publicitaire ou de tracking commercial n'est utilisé sur
          notre plateforme.
        </p>
      </section>
      ...
      <section class="privacy-section">
        ...
        <p>
          Vos données personnelles sont traitées et stockées exclusivement au
          sein de l'Union Européenne. Aucun transfert vers des pays tiers n'est
      ...
      <section class="privacy-section">
        ...
        <div class="contact-grid">
          <div class="contact-item">
            ...
            <p>
              <strong>Email :</strong>
              <a href="mailto:apajh94.secretary@gmail.com"
                >apajh94.secretary@gmail.com</a
              >
            </p>
            <p><strong>Téléphone :</strong> 01 43 99 20 85</p>
            <p>
              <strong>Courrier :</strong> DPO - APAJH<br />2 Rue Alfred Gillet,
      ...
      <section class="privacy-section">
        ...
        <p>
          ...
          les changements dans nos pratiques ou la réglementation. Nous vous
          informerons de toute modification importante par email ou via un avis
          sur la plateforme.
        </p>
        <p>
    ...
    >
      <div class="modal-content" @click.stop>
        ...
        <p>
          <strong>Attention :</strong> Cette action peut être irréversible et
          entraîner la perte de l'historique éducatif de votre enfant.
        </p>
      </div>
    </div>
  </div>
...
async function requestDataAccess() {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/auth/request-data-access`, {
      method: "POST",
      headers: {
    ...
    if (response.ok) {
      toast.success(
        "Votre demande d'accès aux données a été enregistrée. Vous recevrez une réponse sous 72h."
      );
    } else {
    ...
    toast.error(
      "Erreur lors de l'envoi de la demande. Contactez directement le DPO."
    );
  }
}
...
async function submitDeletionRequest() {
  try {
    ...
    if (response.ok) {
      toast.success(
        "Votre demande de suppression a été enregistrée. Le DPO vous contactera sous 72h."
      );
