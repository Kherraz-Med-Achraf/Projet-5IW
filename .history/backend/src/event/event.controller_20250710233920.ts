...
export class EventController {
  ...
  /** 1bis. Mes inscriptions (parent) - DOIT ÊTRE AVANT :id */
  @Get('mine')
  @Roles(Role.PARENT)
  ...
  /** 1ter. Confirmation Stripe (redirect) - DOIT ÊTRE AVANT :id */
  ...
  /** 1quater. Détails d'un événement spécifique - APRÈS les routes spécifiques */
  @Get(':id')
  @Roles(
    Role.PARENT,
    Role.DIRECTOR,
