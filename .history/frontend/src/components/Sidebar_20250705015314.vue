...
function navigate(routeName: string) {
  ...
  if (route.name === routeName) {
    console.log(`Sidebar: Already on ${routeName}, skipping navigation`);
    return;
  }
  
  console.log(`Sidebar: Navigating from ${route.name} to ${routeName}`);
  ...
  router.push({ name: routeName }).then(() => {
    console.log(`Sidebar: Successfully navigated to ${routeName}`);
    console.log(`Sidebar: New path: ${route.path}`);
    console.log(`Sidebar: New route name: ${route.name}`);
  }).catch((error) => {
