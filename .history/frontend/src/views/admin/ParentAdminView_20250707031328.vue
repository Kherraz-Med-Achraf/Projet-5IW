...
async function fetchParents() {
  ...
  try {
    ...
    parents.value = [
      { id: 1, firstName: 'Catherine', lastName: 'Bernard', email: 'catherine.bernard@exemple.com', phone: '06 12 34 56 78', createdAt: '2024-01-15' },
      { id: 2, firstName: 'Philippe', lastName: 'Roux', email: 'philippe.roux@exemple.com', phone: '06 98 76 54 32', createdAt: '2024-02-20' },
    ];
    if (grid.value) {
      grid.value.updateConfig({ data: parents.value }).forceRender();
    }
  } catch (err: any) {
        ...
        formatter: (cell, row) => {
          ...
          return html(`
            <div class="action-buttons">
              <button class="btn-icon edit-btn" data-id="${parent.id}" title="Modifier">
                <i class="material-icons">edit</i>
              </button>
              <button class="btn-icon delete-btn" data-id="${parent.id}" title="Supprimer">
