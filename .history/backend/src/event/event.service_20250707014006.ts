...
export class EventService {
  ...
  async listUpcoming() {
    ...
    console.log('[EventService] Events récupérés de la DB:', events.length);
    events.forEach((ev, index) => {
      console.log(`  ${index}: ${ev.title} - isLocked:`, ev.isLocked, typeof ev.isLocked);
    });
    ...
    console.log('[EventService] Events avec capacityLeft:', withCap.length);
    withCap.forEach((ev, index) => {
      console.log(`  ${index}: ${ev.title} - isLocked:`, ev.isLocked, typeof ev.isLocked);
    });
  ...
  async create(dto: CreateEventDto, creatorUserId: string, imageUrl?: string) {
    ...
    console.log('[EventService] Événement créé:', {
      id: createdEvent.id,
      title: createdEvent.title,
      isLocked: createdEvent.isLocked,
      isLockedType: typeof createdEvent.isLocked
    });
