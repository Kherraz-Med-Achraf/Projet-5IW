...
export class ChildService {
  ...
  /**
   * Crée un enfant ET son compte utilisateur.
   * Interdit tout doublon prénom+nom dans la base.
   */
  ...
  /**
   * Met à jour un enfant pour un parent donné.
   * Interdit doublon prénom+nom dans la base pour un autre record.
   */
  async updateForParent(
    ...
    const result = await this.prisma.$transaction(async tx => {
      ...
      // Adapter le login si le nom/prénom a changé
  ...
  /** Supprime un enfant ET son compte si existant */
