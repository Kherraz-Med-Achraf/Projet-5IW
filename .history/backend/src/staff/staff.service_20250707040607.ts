    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      const profile = await tx.staffProfile.create({
        data: {
          ...
          phone,
          discipline,
          diplomaDate: diplomaDate ? new Date(diplomaDate) : null,
        },
      });
      ...
      return {
        ...
        diplomaDate: profile.diplomaDate,
  ...
  async update(id: number, dto: UpdateStaffDto) {
    ...
    return this.prisma.staffProfile.update({
      ...
      data: {
        ...
        ...(dto.diplomaDate !== undefined && {
          diplomaDate: dto.diplomaDate ? new Date(dto.diplomaDate) : null,
        }),
      },
    });
  }
