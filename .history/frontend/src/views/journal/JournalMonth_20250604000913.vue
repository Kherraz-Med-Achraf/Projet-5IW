...
<template>
    <div class="p-4 max-w-3xl mx-auto">
      ...
      <div v-else>
        ...
        <div class="mb-4">
          ...
          <!-- Liste des pièces avec aperçu et case à cocher -->
          <ul class="list-disc list-inside mb-2">
            ...
            >
              <div class="flex items-center space-x-2">
                <!-- Vignette / aperçu miniature -->
                <div class="flex-shrink-0">
                  <img
                    v-if="isImage(att)"
                    :src="`http://localhost:3000/${att.filepath}`"
                    alt="Aperçu"
                ...
                <input
                  ...
                  class="form-checkbox"
                />
                <label :for="'cb-' + att.id" class="underline text-blue-600 flex-1">
                  <a
  ...
  /**
   * Détermine si l'attachement est une image (png, jpg, jpeg, gif, svg)
   */
  function isImage(att: any): boolean {
    return /\.(png|jpe?g|gif|svg)$/i.test(att.filename)
  }
