...
const handleSubmit = async () => {
  ...
  // 🔧 DEBUG: Vérifier la valeur de la checkbox
  console.log('🔍 DEBUG handleSubmit:')
  console.log('- form.requiresSignature:', form.value.requiresSignature, typeof form.value.requiresSignature)
  console.log('- checkbox element value:', document.querySelector('input[type="checkbox"]')?.checked)
  console.log('- entire form state:', JSON.stringify(form.value, null, 2))
  ...
  try {
    ...
    console.log('🔍 DEBUG payload before sending:', JSON.stringify(payload, null, 2))
