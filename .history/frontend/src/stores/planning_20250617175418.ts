...
export const usePlanningStore = defineStore('planning', {
  state: () => ({
    ...
    /** URLs locales pour télécharger l’Excel importé par staffId */
  ...
  actions: {
    ...
    /** 4. Télécharger l’Excel déjà importé pour un éducateur */
    ...
    /** 5. Prévisualiser l’ensemble des imports déjà effectués */
    ...
    /** 6. Valider (soumettre) le planning final pour le semestre */
