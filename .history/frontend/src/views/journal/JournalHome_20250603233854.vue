...
<template>
          ...
          >
            <span class="block text-center py-2">
              ...
              <span
                ...
                class="text-blue-600"
              >📋</span>
              <!-- ✎ pour tous les autres mois non soumis (y compris passés sans brouillon) -->
              <span
   ...
   * - mois futurs → faux
   * - sinon, on peut toujours éditer s'il n'est pas soumis (brouillon ou pas encore créé)
   */
  function isMonthEditable(month: number): boolean {
    ...
    // Sinon, on retourne vrai pour tous les mois passés/en cours (un brouillon sera créé ou modifié)
    return true
  }
