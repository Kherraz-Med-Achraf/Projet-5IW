...
onMounted(async () => {
  try {
    ...
    console.log('🔍 [COMPONENT] Store après fetch:', childStore.referentChildren)
    ...
    console.log('🔍 [COMPONENT] Enfants après filtrage local:', uniqueChildren)
    ...
    console.log('🔍 [COMPONENT] children.value final:', children.value)
