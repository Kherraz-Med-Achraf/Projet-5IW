...
export class ChatService {
  ...
  async updateMessage(chatId: string, msgId: string, userId: string, content: string) {
    ...
    console.log('[DEBUG] updateMessage - msg.author:', JSON.stringify(msg.author), 'typeof:', typeof msg.author);
    console.log('[DEBUG] updateMessage - userId:', JSON.stringify(userId), 'typeof:', typeof userId);
    console.log('[DEBUG] updateMessage - comparison result:', msg.author !== userId);
    
    if (msg.author.toString() !== userId.toString()) {
      console.log('[DEBUG] updateMessage - FORBIDDEN: Author mismatch');
