  ...
  <div class="event-list">
    ...
    <div v-for="ev in eventStore.events" :key="ev.id" class="card">
      ...
      <div class="content">
        ...
        <button @click="openModal(ev)">S'inscrire</button>
      </div>
    </div>
...
// enfants du parent
const childrenStore = useChildStore?.() // may not exist; but assume there is childStore.ts
...
onMounted(()=>{ eventStore.fetchEvents(); if(childrenStore) childrenStore.fetchChildren?.() })
</script>
