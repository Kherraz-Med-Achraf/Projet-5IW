            ...
            <div class="config-grid">
              ...
              <div class="config-block" v-if="sheet" role="region" aria-labelledby="validation-title">
                ...
                <div class="summary-display" role="list">
                  ...
                  <div class="summary-item" role="listitem" :aria-label="`Dernière modification le ${formatDate(lastModificationDate)} à ${formatTime(lastModificationDate)}`">
                    <i class="material-icons" aria-hidden="true">update</i>
                    <div class="modification-details">
                      <span class="modification-label">Dernière modification :</span>
                      <span class="modification-date">{{ formatDate(lastModificationDate) }}</span>
                      <span class="modification-time">{{ formatTime(lastModificationDate) }}</span>
                    </div>
                  </div>
                </div>
              </div>
