...
export class MailService {
  ...
  constructor() {
    ...
    // Configuration SMTP explicite pour éviter les timeouts en production
    ...
    this.logger.log(`   Host: smtp.gmail.com`);
    this.logger.log(`   Port: 587`);
    this.logger.log(`   Secure: false`);
  }
