...
export class SecretaryService {
  ...
  /**
   * Crée un secrétaire en garantissant :
   * - unicité de l'email dans User
   * - unicité du couple prénom+nom dans SecretaryProfile
   */
  async create(dto: CreateSecretaryDto) {
    ...
    // 2) Vérification doublon prénom+nom
    ...
    // 4) Transaction : création User + SecretaryProfile
