      ...
      <div class="profile-content">
        <div class="content-grid">
          ...
          <div class="control-panel">
            <!-- Sélection de date -->
            <div class="control-card date-card">
            ...
            <div class="control-card stats-card" v-if="sheet">
              <div class="card-header">
              ...
              <div class="card-content">
                <div class="quick-stats">
                  ...
                  <div class="stat-item">
                    ...
                    <span class="stat-value primary">{{ presentCount }}</span>
                  </div>
                  <div class="stat-item">
                    <span class="stat-label">Absents</span>
                    <span class="stat-value danger">{{ totalCount - presentCount }}</span>
                  </div>
                </div>
              </div>
            </div>
