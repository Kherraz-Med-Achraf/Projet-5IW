  ...
  <div class="profile-container">
    ...
    <div id="main-content" class="profile-content">
      ...
      <div v-else class="missions-container">
        <!-- Missions Section -->
        <div v-if="missionsList.length > 0" class="profile-section missions-section">
        ...
        <div class="action-bar">
          <button @click="onBack" class="edit-btn edit-btn-custom">
          ...
          <div class="delete-confirmation">
            ...
            <div class="delete-content">
              <p class="delete-message">
                Êtes-vous sûr de vouloir supprimer définitivement cette mission ?
              </p>
              ...
              <p class="delete-warning">
                ...
                Cette action est irréversible et la mission sera définitivement supprimée.
              </p>
            </div>
          </div>
        </div>
