...
// canUpload: semestre, staff + fichier sélectionnés, et pas de chargement en cours
...
// Au montage, on charge semestres et staff
onMounted(async () => {
  await planning.fetchSemesters()
  await planning.fetchStaffList()
  // si l’utilisateur est staff, on le pré-sélectionne
