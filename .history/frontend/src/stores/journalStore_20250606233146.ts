Je me repete une derniere toi :
Corrige en partant de ce fichier :
...
Corrige ce qui est nécéssaire et laisse le reste intact mais envoie le fichier en ENTIER POUR QUE JE PUISSE COPIER COLLER