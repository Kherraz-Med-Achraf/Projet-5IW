...
/* Bouton bleu pour la validation */
.edit-btn-blue {
...
.edit-btn-blue:focus:not(:disabled) {
...
/* Grid headers avec police Satoshi Black - Avec hover bleu différent */
:deep(.grid-header) {
...
/* Hover bleu différent pour les en-têtes */
:deep(.grid-header:hover) {
  background-color: #3730a3;
}

/* Focus accessible pour les en-têtes */
...
/* Lignes d'enfants sans hover - Seulement focus pour accessibilité */
...
/* Icône de loupe ajoutée dynamiquement */
:deep(.search-icon) {
  position: absolute;
  left: 1rem;
  top: 1rem;
...
/* Icône plus visible au focus */
:deep(.gridjs-search input:focus) ~ .search-icon {
  color: #4338ca;
}
