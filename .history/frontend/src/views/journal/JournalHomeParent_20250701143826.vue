...
<template>
  <div class="journal-parent-container">
    ...
    <div class="selection-section">
      ...
      <div v-if="selectedChildId" class="selection-card">
        <div class="card-header">
    ...
    <!-- Actions principales -->
    <div v-if="selectedChildId && selectedYearId && hasAnySubmittedJournal" class="actions-section">
      <div class="actions-card">
        ...
        <div class="card-content">
          <button @click="exportYearReport" class="btn btn-primary">
    ...
    <div v-if="selectedChildId && selectedYearId" class="months-section">
      ...
      <div class="months-grid">
        ...
        >
          <div class="month-header">
            <span class="month-number">{{ monthNum.toString().padStart(2, '0') }}</span>
          ...
          <div class="month-content">
            <div v-if="journalExists(monthNum)" class="month-available">
              ...
              <button @click="viewReport(monthNum)" class="btn btn-outline">
