...
/** 3) Filter + map des événements **/
// Ton service renvoie désormais **tous** les créneaux sur tout le semestre
...
/** 5) Centre la vue sur la date de début du semestre **/
...
/** 6) Dès qu’on choisit un staff, on injecte les events calculés **/
watch(
