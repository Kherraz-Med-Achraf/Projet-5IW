...
const allEntries = computed(() => planning.previewEntries)  // rename selon store
...
async function previewAll() {
  ...
  // on selectionne le semestre une fois pour le store
...
async function importAll() {
  ...
  // idem, on positionne le semestre dans le store
  planning.selectSemester(selectedSemesterId.value)
  await planning.importAll(file.value!)
  // puis on recharge l’aperçu global
