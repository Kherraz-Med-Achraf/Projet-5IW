...
export class YousignService {
  ...
  /* 2️⃣  upload PDF (on force le .pdf) --------------------------------- */
  ...
  /* 3️⃣  ajout d’un signer (plus de champs interdits) ------------------ */
  private addSigner(
    reqId: string,
    ...
    return this.call<SignerRes>(
      `signature_requests/${reqId}/signers`,
      {
        ...
        json: {
          ...
          signature_level: 'electronic_signature',   // autorisé
        },
      },
    );
  }
