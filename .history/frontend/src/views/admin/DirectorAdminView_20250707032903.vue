...
// Fonctions CRUD (à implémenter avec les vrais appels API)
async function fetchDirectors() {
  ...
  try {
    ...
    directors.value = [
      { id: 1, firstName: 'Jean', lastName: 'Dupont', email: 'jean.dupont@exemple.com', createdAt: '2024-01-15' },
      { id: 2, firstName: 'Marie', lastName: 'Martin', email: 'marie.martin@exemple.com', createdAt: '2024-02-20' },
    ];
    if (grid.value) {
      grid.value.updateConfig({ data: directors.value }).forceRender();
    }
  } catch (err: any) {
      ...
      { id: 'createdAt', name: 'Date de création' },
      {
        ...
        formatter: (cell, row) => {
          const director = {
            ...
            createdAt: row.cells[3].data,
          };
          return html(`
            <div class="action-buttons">
              <button class="btn-icon edit-btn" data-id="${director.id}" title="Modifier">
                <i class="material-icons">edit</i>
              </button>
              <button class="btn-icon delete-btn" data-id="${director.id}" title="Supprimer">
