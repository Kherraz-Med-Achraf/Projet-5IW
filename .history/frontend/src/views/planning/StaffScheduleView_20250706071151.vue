         ...
         <section class="profile-section">
           <header class="section-header">
             ...
             <div class="info-note" role="note">
               ...
               <span>Consultation de vos créneaux et activités</span>
             </div>
           </header>
         </section>
          ...
          <div class="instructions-section">
            <div class="instruction-card">
              ...
              <div class="instruction-content">
                <h4>Votre planning éducateur</h4>
                <ul>
                  <li><strong>Vue semaine :</strong> Détail de vos créneaux par jour</li>
                  <li><strong>Vue mois :</strong> Aperçu général de vos activités</li>
                  <li><strong>Clic sur un cours :</strong> Voir les enfants concernés</li>
                </ul>
              </div>
            </div>
          </div>
...
const calendarOptions = computed(() => ({
  ...
  slotDuration: '01:00:00', // Créneaux d'1 heure
  slotLabelInterval: '01:00:00', // Labels toutes les heures
  height: 'auto',
  allDaySlot: false,
  allDayText: '',
  eventMinHeight: 40, // Hauteur minimale des événements
  expandRows: true, // Étendre les lignes pour remplir l'espace
...
// FORCER les événements à occuper EXACTEMENT leur durée temporelle
:deep(.fc-timegrid-event) {
  margin: 0 !important;
  padding: 0 !important;
  border-radius: 4px !important;
...
:deep(.fc-timegrid-event .fc-event-time) {
  display: none !important; // Cacher l'heure redondante
}
