...
const displayEvents = computed(() => {
  ...
  return events.value.map(event => {
    ...
    if (baseEvent.extendedProps.cancelled) {
      baseEvent.backgroundColor = '#B0BEC5'
      baseEvent.borderColor = '#90A4AE'
    } else if (baseEvent.extendedProps.vacation) {
      baseEvent.backgroundColor = '#FFB74D'
      baseEvent.borderColor = '#FF9800'
    } else {
      baseEvent.backgroundColor = '#4338ca'
      baseEvent.borderColor = '#3730a3'
    }
