...
// État des onglets
const activeTab = ref<'present' | 'pending' | 'absences'>('pending')
...
// Gestion des onglets
function setActiveTab(tab: 'present' | 'pending' | 'absences') {
  activeTab.value = tab
}

// Auto-sélection du premier onglet disponible
watch([presentRecords, pendingRecords, justifiedAbsences], () => {
