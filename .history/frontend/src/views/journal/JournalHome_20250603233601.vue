...
<template>
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          >
            <span class="block text-center py-2">
              {{ label }}
              <!-- checkbox pour mois déjà soumis -->
              <span v-if="isMonthConsultable(index + 1)" class="text-green-600">✔</span>
              <!-- 📋 pour brouillon (mois passé/en cours non soumis) -->
   ...
   * - mois passés/en cours non soumis → case "normale"
   */
  function monthClass(month: number) {
    ...
    // Sinon (mois passé ou en cours, non soumis) → case "normale"
