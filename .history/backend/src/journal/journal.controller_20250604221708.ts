  ...
  export class JournalController {
    ...
    @UseInterceptors(
      FileInterceptor('file', {
        storage: diskStorage({
          /**
           * On pointe explicitement vers le dossier `uploads/` à la racine du projet.
           * process.cwd() renvoie le chemin du dossier où se lance node (ici mon-projet-backend).
           */
    ...
    async uploadAttachment(
      ...
      // 3) Créer l’attachement en base et renvoyer l’objet JournalAttachment
