  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        imgSrc: ["'self'", "data:", "blob:", "https:", "http://localhost:3000", "http://localhost:5173"],
    ...
    crossOriginResourcePolicy: { policy: "cross-origin" }, // Autoriser cross-origin pour les images
  }));
