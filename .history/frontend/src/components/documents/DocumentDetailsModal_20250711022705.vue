          ...
          <div class="detail-section">
            <div class="section-header">
              ...
              <div class="stats-summary">
                <span class="stat-badge">{{ documentDetails._count?.accesses || 0 }} parents</span>
                <span v-if="documentDetails.requiresSignature" class="stat-badge">
                  {{ documentDetails._count?.signatures || 0 }} signatures
                </span>
              </div>
            </div>
                ...
                >
                  <div class="access-parent">
                    ...
                    <div class="access-status">
                      ...
                      <span v-else class="status-not-viewed">
...
const addAccess = async () => {
  ...
  try {
    await documentStore.addDocumentAccess(props.document.id, selectedParentIds.value)
...
const removeAccess = async (parentId: number) => {
  ...
  try {
    await documentStore.removeDocumentAccess(props.document.id, [parentId])
