...
export class YouSignService {
  ...
  constructor() {
    ...
    // 🔧 DEBUG: Vérifier la configuration YouSign
    console.log('🔍 DEBUG YouSign Configuration:')
    console.log('- API Base URL:', this.config.apiBaseUrl)
    console.log('- API Key present:', !!this.config.apiKey, this.config.apiKey ? `(${this.config.apiKey.substring(0, 10)}...)` : '(missing)')
    console.log('- Webhook Secret present:', !!this.config.webhookSecret)
