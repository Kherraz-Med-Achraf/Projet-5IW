...
describe('AuthService – login() avec OTP', () => {
  ...
  it('refuse un otpCode invalide', async () => {
    // @ts-ignore – speakeasy.totp.verify n'est pas typé
    jest.spyOn(speakeasy.totp as any, 'verify').mockReturnValue(false as any)
  ...
  it('accepte un otpCode valide et renvoie les tokens', async () => {
    // @ts-ignore – speakeasy.totp.verify n'est pas typé
    jest.spyOn(speakeasy.totp as any, 'verify').mockReturnValue(true as any)
