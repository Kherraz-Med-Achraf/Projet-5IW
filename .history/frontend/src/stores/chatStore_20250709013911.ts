...
export const useChatStore = defineStore("chat", () => {
  ...
  async function fetchContacts() {
    ...
    try {
      ...
      console.log("[ChatStore] Contacts reçus du backend:", rawContacts);
      ...
      console.log("[ChatStore] Contacts après déduplication:", uniqueContacts);
  ...
  async function init() {
    ...
    socket.on("newMessage", (msg: any) => {
      ...
      // Debug: informations sur le message reçu
      console.log("[ChatStore] Message WebSocket reçu - authorId:", msg.authorId, "user actuel:", auth.user?.id);
      console.log("[ChatStore] Message WebSocket reçu - égalité authorId:", msg.authorId === auth.user?.id);
