  ...
  const columns = [
    ...
    },
    {
      ...
      formatter: (cell: any, row: any) => {
        // Dans GridJS avec des arrays, row.cells[index] contient les données
        const childId = row.cells[2].data
        const isPresent = row.cells[3].data
        const justificationType = row.cells[4].data
        
        console.log('Formatter called with:', { childId, isPresent, justificationType })
