    ...
    <div class="profile-content">
      <div class="content-grid">
        ...
        <div v-if="sheet" class="profile-section children-section">
          ...
          <!-- GridJS Table -->
          <div v-if="sheet.records.length > 0" ref="gridContainer" class="grid-container"></div>
...
/* Sections - Design plat sans emboîtement */
.profile-section {
  padding: 1rem 0;
}

/* Section headers - Sans border */
.section-header {
  display: flex;
  align-items: center;
...
/* Amélioration du wrapper du grid - Complètement neutre */
:deep(.grid-wrapper) {
  overflow: hidden;
}
...
/* Grid headers avec police Satoshi - Design simplifié sans border */
:deep(.grid-header) {
