...
<template>
  <main class="journal-container" role="main" lang="fr">
...
/* Container principal - Journal specific styles without min-height constraint */
.journal-container {
  ...
  padding: 1rem 0;
  overflow-x: hidden;
  /* No min-height constraint - content determines height */
  height: auto;
  overflow-y: visible;
}
...
.journal-month-container {
  ...
  padding: 0 1rem;
  padding-bottom: 2rem;
  /* Ensure no fixed height constraints */
  min-height: unset !important;
  height: auto !important;
  overflow: visible !important;
}
