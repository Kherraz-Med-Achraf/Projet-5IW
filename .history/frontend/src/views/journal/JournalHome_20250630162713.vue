      ...
      <div class="content-grid">
        ...
        <div v-if="selectedChildId && selectedYearId" class="profile-section">
          ...
          <div v-else class="empty-state">
            ...
            <small>Cliquez sur "Gérer les missions" pour en créer.<br>Pour voir le calendrier mensuel, il faut que l'enfant ait au moins une mission définie.</small>
          </div>
        </div>

        <!-- Calendrier mensuel -->
        <div v-if="selectedYearId && missions.length > 0" class="profile-section">
          <div class="section-header">
            <h2>
