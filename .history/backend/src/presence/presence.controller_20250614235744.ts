...
import {
  ...
  export class PresenceController {
    ...
    validateSheet(
      ...
      // staffId étant récupéré dans le service via req.user, si vous préférez
      // l’injecter ici, vous pouvez également ajouter @Req() mais on peut aussi
      // en passer un pour la cohérence :
      return this.service.validateSheet(
        sheetId,
        dto.presentChildIds,
        dto.staffId, // ou req.user.id si staffId vient du token
      );
    }
