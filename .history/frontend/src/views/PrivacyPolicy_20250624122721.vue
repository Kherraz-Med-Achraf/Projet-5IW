  ...
  <div class="privacy-policy">
        ...
        <div class="data-categories">
          ...
          <div class="data-category sensitive">
            ...
            <p class="sensitive-note">
              ⚠️ Ces données sont particulièrement protégées et stockées sur des serveurs 
      ...
      <section class="privacy-section">
        ...
        <div class="user-rights">
          <div class="right">
            ...
            <button @click="requestDataAccess" class="action-button">
          ...
          <div class="right">
            ...
            <button @click="showDeleteModal = true" class="action-button danger">
          ...
          <div class="right">
            ...
            <button @click="downloadData" class="action-button">
          ...
          <div class="right">
            ...
            <a href="mailto:dpo@apajh.org" class="action-button">
              Contacter le DPO
            </a>
          </div>
          ...
          <div class="right">
            ...
            <router-link to="/profile/consents" class="action-button">
    ...
    <div v-if="showDeleteModal" class="modal-overlay" @click="showDeleteModal = false">
      <div class="modal-content" @click.stop>
        ...
        <p>
          Vous êtes sur le point de demander la suppression de votre compte et de vos données personnelles.
        </p>
        <p>
        ...
        <div class="modal-actions">
          ...
          <button @click="submitDeletionRequest" class="btn-danger">
...
const lastUpdated = ref('15 janvier 2025')
