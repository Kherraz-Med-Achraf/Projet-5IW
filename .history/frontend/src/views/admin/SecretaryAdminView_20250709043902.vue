      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form @submit.prevent="saveSecretary" class="secretary-form">
            ...
            <div class="form-group" v-if="!editingSecretary">
            ...
            <div class="form-group">
              ...
              <input id="specialty" v-model="formData.specialty" type="text" required placeholder="Ex: Accueil, Administration, Secrétariat médical..." />
            </div>
            <div class="form-group">
...
function editSecretary(secretary: any) {
  ...
  formData.value = {
    ...
    email: secretary.user?.email || secretary.email,
