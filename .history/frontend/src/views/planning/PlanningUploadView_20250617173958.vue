...
// toutes les entrées importées pour l’aperçu agrégé
...
// on considère "tout importé" si on a importé un Excel pour chaque éducateur
...
async function previewAll() {
  ...
  await planning.selectSemester(selectedSemesterId.value)
  await planning.fetchAggregated(selectedSemesterId.value)
}

async function submitAll() {
  if (!allImported.value) return
  await planning.submitPlanning(selectedSemesterId.value)
