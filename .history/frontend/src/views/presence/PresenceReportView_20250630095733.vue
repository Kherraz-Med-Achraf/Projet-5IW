        ...
        <div class="content-grid">
              ...
              <div class="config-block" v-if="sheet">
                ...
                <div class="summary-display">
                  <div class="summary-item">
                    ...
                    <span class="summary-label">Total enfants :</span>
                    <span class="summary-value">{{ totalCount }}</span>
                  </div>
                  
                  <div v-if="sheet.validatedAtStaff && sheet.staff" class="summary-item validation-info">
                    <i class="material-icons" aria-hidden="true">person_check</i>
                    <div class="validation-details">
                      <span class="validation-label">Validé par :</span>
                      <span class="validation-staff">{{ sheet.staff.firstName }} {{ sheet.staff.lastName }}</span>
                      <span class="validation-date">{{ formatDateTime(sheet.validatedAtStaff) }}</span>
                    </div>
                  </div>
                  
                  <div v-else-if="sheet.status === 'PENDING_STAFF'" class="summary-item pending-validation">
                    <i class="material-icons" aria-hidden="true">pending</i>
                    <span class="summary-label">En attente de validation staff</span>
                  </div>
                  
                  <div v-else class="summary-item draft-status">
                  ...
                  <div class="summary-item">
                    ...
                    <span class="summary-value">{{ formatDateTime(sheet.updatedAt) }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="kpi-grid" role="group" aria-labelledby="kpi-section">
              ...
              <div class="kpi-card lateness">
                ...
                <div class="kpi-content">
                  ...
                  <div class="kpi-value" :aria-label="`Taux de retard: ${latenessRate} pourcent`">
              ...
              <div class="kpi-card unjustified-absences" :class="{ 'kpi-warning': unjustAbsenceRate > 10 }">
                <div class="kpi-icon">
              ...
              <div class="kpi-card justified-absences">
                <div class="kpi-icon">
                  <i class="material-icons" aria-hidden="true">event_busy</i>
                </div>
                <div class="kpi-content">
                  <h3>Absences justifiées</h3>
                  <div class="kpi-value" :aria-label="`Absences justifiées: ${justifiedAbsenceRate} pourcent`">
          ...
          <div v-if="sheet" class="profile-section" id="data-table">
            ...
            <div class="search-container">
              ...
              <div v-if="searchQuery && filteredRecords.length !== sheet.records.length" class="search-results">
          ...
          <div v-else class="profile-section loading-section">
            ...
            <div v-else class="no-data-content">
              ...
              <p class="no-data-hint">Les feuilles de présence sont généralement créées automatiquement en semaine ou peuvent être créées manuellement par le personnel.</p>
            </div>
          </div>
