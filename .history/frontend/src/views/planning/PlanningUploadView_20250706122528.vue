...
<template>
  <main class="profile-container" role="main">
    ...
    <div class="profile-content" id="main-content">
        ...
        <section v-if="previewEntries.length" class="profile-section config-section" aria-labelledby="stats-title">
          <div class="section-header">
            <h2 id="stats-title">
        ...
        <!-- Sélection éducateur -->
        <section v-if="previewEntries.length || hasExistingPlanning" class="profile-section config-section" aria-labelledby="staff-title">
          <div class="section-header">
            <h2 id="staff-title">
...
.config-section .staff-selection {
  margin: 0;
  padding: 2rem;
}
