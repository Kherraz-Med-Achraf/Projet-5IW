...
const staffName = computed(() => {
  // Pour l'instant, utiliser une valeur par défaut en attendant les données du staff
  return 'Équipe'
})
...
/* Table container avec meilleure présentation - Harmonisé */
.table-container {
  margin-top: 1.5rem;
  border-radius: 1rem;
  overflow: hidden;
...
/* Grid headers avec police Satoshi - Design amélioré */
:deep(.grid-header) {
