...
function removeMission(index: number) {
  ...
  // Avertir l'utilisateur qu'il doit sauvegarder pour que la suppression soit persistante
  if (missionsList.length === 0) {
    toast.warning(
      "N'oubliez pas de cliquer sur 'Enregistrer' pour confirmer la suppression de toutes les missions.",
      { timeout: 5000 }
    );
  }
}
