      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form @submit.prevent="saveServiceManager" class="service-manager-form">
            ...
            <div class="form-group" v-if="!editingServiceManager">
            ...
            <div class="form-group">
              ...
              <input
                ...
                type="text"
                required
                placeholder="Ex: Chef de service éducatif, Responsable pédagogique, Coordinateur..."
              />
            </div>
...
function editServiceManager(serviceManager: any) {
  ...
  formData.value = {
    ...
    email: serviceManager.user?.email || serviceManager.email,
    password: '', // Password is not editable in this modal
    phone: serviceManager.phone,
    birthDate: serviceManager.birthDate,
    jobTitle: serviceManager.jobTitle,
    startDate: serviceManager.startDate,
  };
  showModal.value = true;
}
