<template>
  <div class="register-step">
    <div class="register-step__container">
      <h2 class="register-step__title">Informations des enfants</h2>
      ...
      <div class="register-step__section">
        ...
        >
          <h4 class="register-step__subtitle">Enfant {{ index + 1 }}</h4>
          ...
          <button class="register-step__remove-btn" @click="removeChild(index)">
            ✕
          </button>
        </div>

        <button class="register-step__add-btn" @click="addChild">
          + Ajouter un enfant
        </button>
      </div>

      <!-- Message d'information -->
      <div class="register-step__info-box">
        <div class="register-step__info-content">
          <div class="register-step__info-icon">
      ...
      <div v-if="form.children.length === 0" class="register-step__empty-state">
        <div class="register-step__empty-icon">
      ...
      <div class="register-step__nav-buttons">
        <button class="register-step__prev-btn" @click="goToStep1">
          Précédent
        </button>
        <button class="register-step__next-btn" @click="goToStep3">
          Suivant
        </button>
      </div>
    </div>
