...
describe('AuthService – login() avec OTP', () => {
  ...
  it('refuse un otpCode invalide', async () => {
    jest.spyOn<any, any>(speakeasy.totp as any, 'verify').mockReturnValue(false as any)
  ...
  it('accepte un otpCode valide et renvoie les tokens', async () => {
    jest.spyOn<any, any>(speakeasy.totp as any, 'verify').mockReturnValue(true as any)
