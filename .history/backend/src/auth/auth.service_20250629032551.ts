      ...
      case 'PARENT':
        if (user.parentProfile) {
          profileInfo = {
            ...
            phone: user.parentProfile.phone ? user.parentProfile.phone.replace(/(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})/, '$1 $2 ** ** $5') : null,
            address: 'Renseignée',
            ...
            emergencyContacts: user.parentProfile.emergencyContacts.map(contact => ({
              id: contact.id,
              name: contact.name,
              relation: contact.relation,
              phone: contact.phone ? contact.phone.replace(/(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})/, '$1 $2 ** ** $5') : null,
            })),
          };
        }
        break;
      ...
      case 'STAFF':
        if (user.staffProfile) {
          profileInfo = {
            ...
            phone: user.staffProfile.phone ? user.staffProfile.phone.replace(/(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})/, '$1 $2 ** ** $5') : null,
            birthDate: user.staffProfile.birthDate ? user.staffProfile.birthDate.getFullYear() : null,
      ...
      case 'SECRETARY':
        if (user.secretaryProfile) {
          profileInfo = {
            ...
            phone: user.secretaryProfile.phone ? user.secretaryProfile.phone.replace(/(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})/, '$1 $2 ** ** $5') : null,
            birthDate: user.secretaryProfile.birthDate ? user.secretaryProfile.birthDate.getFullYear() : null,
      ...
      case 'DIRECTOR':
        if (user.directorProfile) {
          profileInfo = {
            ...
            phone: user.directorProfile.phone ? user.directorProfile.phone.replace(/(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})/, '$1 $2 ** ** $5') : null,
            birthDate: user.directorProfile.birthDate ? user.directorProfile.birthDate.getFullYear() : null,
      ...
      case 'SERVICE_MANAGER':
        if (user.serviceManagerProfile) {
          profileInfo = {
            ...
            phone: user.serviceManagerProfile.phone ? user.serviceManagerProfile.phone.replace(/(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})/, '$1 $2 ** ** $5') : null,
            birthDate: user.serviceManagerProfile.birthDate ? user.serviceManagerProfile.birthDate.getFullYear() : null,
      ...
      case 'CHILD':
        if (user.childProfile) {
          profileInfo = {
            ...
            birthDate: user.childProfile.birthDate ? user.childProfile.birthDate.getFullYear() : null,
          };
        }
        break;
    }
