...
export class BlogService {
  ...
  async getAllPosts(userId?: string): Promise<BlogPostResponseDto[]> {
    console.log('[BlogService] getAllPosts - userId:', userId);
    ...
    console.log('[BlogService] getAllPosts - posts récupérés:', posts.length);
    console.log('[BlogService] getAllPosts - premier post raw:', JSON.stringify(posts[0], null, 2));
    ...
    console.log('[BlogService] getAllPosts - posts formatés:', JSON.stringify(formattedPosts, null, 2));
