...
import * as QRCode from 'qrcode'  // Importation de la librairie QRCode pour le navigateur
...
async function generateQRCodeFromSecret(otpSecret: string) {
  // Les mêmes valeurs que dans le backend pour cohérence
...
// À l'initialisation, si l'OTP est déjà activé, coche la case et génère le QR code
onMounted(() => {
