...
export class YousignService {
  ...
  /* 1️⃣  Création de la signature-request (aucun redirect ici) */
  ...
  /* 3️⃣  Ajout d’un signer — conforme doc officielle */
  private addSigner(
    reqId: string,
    ...
    return this.call<SignerRes>(
      `signature_requests/${reqId}/signers`,
      {
        ...
        json: {
          ...
          authentication_modes: ['no_code'],           // validation par lien mail
          redirect_urls       : {                      // redirections
  ...
  /* URL embarquée (0 = secrétaire, 1 = parent) */
