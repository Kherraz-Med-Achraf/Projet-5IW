...
export class AuthService {
  ...
  async changePassword(userId: string, currentPwd: string, newPwd: string) {
    ...
    console.log(`[CHANGE_PASSWORD] Utilisateur ${user.email} change son mot de passe`);
    ...
    console.log(`[CHANGE_PASSWORD] Mot de passe mis à jour avec succès pour ${user.email}`);
