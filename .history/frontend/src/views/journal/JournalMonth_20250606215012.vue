    ...
    <div v-else>
      ...
      <div class="flex space-x-4 mt-6">
        ...
        <p v-if="!isSubmitted && !allMissionsFilled" class="text-red-600 text-sm mt-1">
          Il faut remplir tous les champs de progression pour pouvoir soumettre.
        </p>
        <button
...
/**
 * Indique si toutes les missions ont été renseignées
 * C’est vrai seulement si pour chaque mission, il y a un texte non vide dans form.progressionMissions[mission.id]
 */
...
/**
 * Soumettre définitivement (confirmé via modal)
 */
