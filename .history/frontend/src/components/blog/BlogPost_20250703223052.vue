    ...
    <div class="post-content">
      ...
      <div v-if="post.mediaUrl" class="post-media">
        <div style="background: yellow; padding: 10px; margin: 10px; font-size: 12px;">
          🔧 DEBUG:<br>
          mediaUrl: {{ post.mediaUrl }}<br>
          mediaType: {{ post.mediaType }}<br>
          fullMediaUrl: {{ fullMediaUrl }}<br>
          showImage: {{ post.mediaType === 'IMAGE' }}
        </div>
        <img
          ...
          @load="() => console.log('✅ Image loaded:', fullMediaUrl)"
          @error="(e) => console.error('❌ Image error:', e, fullMediaUrl)"
