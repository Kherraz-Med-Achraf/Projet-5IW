...
/**
 * RolesGuard réutilise les metadata Reflector ; pour tester simplement, on renvoie true.
 * Le test de droit se fait via JwtAuthGuard + décorateurs @Roles.
 */
const allowRolesGuard = { canActivate: () => true };

describe('PlanningController – createSemester (roles)', () => {
  ...
  it('autorise Service Manager', async () => {
