<template>
  <div class="event-list">
    ...
    <div v-if="!eventStore.loading && !eventStore.error" class="events-grid">
      ...
      <div v-for="ev in eventStore.events" :key="ev.id" class="event-card">
        ...
        <div class="event-content">
          ...
          <div class="event-actions">
            <button
              ...
              :class="{ disabled: isRegistrationDisabled(ev) }"
            >
              <span v-if="registeredChildren(ev).length">Déjà inscrit</span>
              <span v-else-if="getCapacityLeft(ev) === 0">Complet</span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select multiple v-model="childIds" class="children-select">
              <option v-for="c in children" :key="c.id" :value="c.id">
                {{ c.firstName }} {{ c.lastName }}
              </option>
            </select>
            <small v-if="children.length === 0" class="no-children">
              Aucun enfant trouvé. Veuillez d'abord ajouter un enfant à votre
              profil.
            </small>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="payment-options">
              <label class="payment-option">
                <input type="radio" value="CHEQUE" v-model="paymentMethod" />
                <span class="radio-custom"></span>
                <div class="payment-info">
                  <span class="payment-name">Chèque</span>
                  <small>Paiement par chèque à remettre sur place</small>
                </div>
              </label>
