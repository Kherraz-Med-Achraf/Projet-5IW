...
export class AuthService {
      ...
      case 'PARENT':
        if (user.parentProfile) {
          profileInfo = {
            ...
            phone: this.maskPhoneNumber(user.parentProfile.phone),
            address: 'Renseignée',
      ...
      case 'STAFF':
        if (user.staffProfile) {
          profileInfo = {
            ...
            phone: this.maskPhoneNumber(user.staffProfile.phone),
      ...
      case 'SECRETARY':
        if (user.secretaryProfile) {
          profileInfo = {
            ...
            phone: this.maskPhoneNumber(user.secretaryProfile.phone),
      ...
      case 'DIRECTOR':
        if (user.directorProfile) {
          profileInfo = {
            ...
            phone: this.maskPhoneNumber(user.directorProfile.phone),
      ...
      case 'SERVICE_MANAGER':
        if (user.serviceManagerProfile) {
          profileInfo = {
            ...
            phone: this.maskPhoneNumber(user.serviceManagerProfile.phone),
  ...
  async updateProfile(userId: string, updateData: { firstName?: string; lastName?: string; phone?: string }) {
    if (!userId) {
      throw new BadRequestException('ID utilisateur manquant');
    }
    ...
    switch (user.role) {
      ...
      default:
        throw new BadRequestException('Type de profil non supporté pour la mise à jour');
    }
