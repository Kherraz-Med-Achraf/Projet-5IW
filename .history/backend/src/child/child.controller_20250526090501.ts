...
export class ChildController {
  ...
  /** 
   * POST /children
   * Seuls les parents peuvent créer leurs propres enfants 
   */
  @Post()
  @Roles(Role.PARENT)
  async create(
   ...
   * Staff/Secrétaire/ServiceManager/Directeur/Admin = tous les enfants
   */
  @Get()
  @Roles(
    Role.PARENT,
   ...
   * GET /children/:id
   * Parents = leurs propres enfants
   * Staff/Secrétaire/ServiceManager/Directeur/Admin = peut accéder à n’importe quel enfant
   */
  @Get(':id')
  @Roles(
    Role.PARENT,
